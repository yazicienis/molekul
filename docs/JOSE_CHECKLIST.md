...
- [ ] Zenodo version DOI: local v0.2.0 metadata and bundle are prepared; mint the version-specific DOI in Zenodo after the v0.2.0 release archive is published.
